...
if (is_page_template('templates/page-team.php')) : ?>
<section class="<?php echo esc_attr($header_classes); ?>" data-track-intersection>
  <?php else: ?>
  <section class="<?php echo esc_attr($header_classes); ?>">
    <?php endif; ?>
    <div class="section-container section-container_decor hero__container">
      <?php if (is_page_template('templates/page-careers.php')) : ?>
