    ...
    <?php elseif (is_page_template('templates/page-careers.php')) : ?>
      ...
      <div id="careers-motto" class="tg-h0 hero__motto motto">
        ...
        <div class="team-motto__star-wrap">
          <svg id="careers-motto-star-1" class="animated-star motto__star motto__star_1" viewBox="0 0 384 388">
        ...
        us
        <div class="team-motto__star-wrap">
          <svg id="careers-motto-star-2" class="animated-star motto__star motto__star_2" viewBox="0 0 384 388">
    ...
    <?php elseif (is_post_type_archive('templates/page-team.php')) : ?>
      ...
      <div id="team-motto" class="tg-h0 motto">Amazing
        ...
        <div class="motto__lightning-wrap">
          <svg id="team-motto-lightning" class="animated-lightning motto__lightning" viewBox="0 0 59 120" fill="none"
