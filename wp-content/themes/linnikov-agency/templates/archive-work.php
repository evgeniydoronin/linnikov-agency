  ...
  <main>
    ...
    <section class="top-cases works__top-cases" id="top-cases">
      <div class="section-container section-container_decor top-cases__container">
        ...
        <!--        <div class="top-cases__body" data-top-cases-elem="body">-->
<!--          <a href="." class="img-wrap img-wrap_cover case-poster case-poster_top" data-caption="Iguana"-->
<!--             data-category="branding, packaging">-->
<!--            <div class="img-wrap__inner">-->
<!--              <picture>-->
...
<!--            </div>-->
<!--          </a>-->
<!--          <a href="." class="img-wrap img-wrap_cover case-poster case-poster_top" data-caption="Khush"-->
<!--             data-category="branding, digital">-->
<!--            <div class="img-wrap__inner">-->
<!--              <picture>-->
...
<!--            </div>-->
<!--          </a>-->
<!--          <a href="." class="img-wrap img-wrap_cover case-poster case-poster_top" data-caption="Project name"-->
<!--             data-category="branding, digital">-->
<!--            <div class="img-wrap__inner">-->
<!--              <picture>-->
...
<!--            </div>-->
<!--          </a>-->
<!--          <a href="." class="img-wrap img-wrap_cover case-poster case-poster_top" data-caption="Aromanty"-->
<!--             data-category="branding">-->
<!--            <div class="img-wrap__inner">-->
<!--              <picture>-->
...
<!--          </a>-->
<!--          <a href="." class="img-wrap img-wrap_cover case-poster case-poster_top" data-caption="Project name"-->
<!--             data-category="branding, digital, packaging">-->
<!--            <div class="img-wrap__inner">-->
<!--              <picture>-->
<!--                <source type="image/webp" srcset="--><?php //echo get_template_directory_uri(); ?><!--/git-src/build/img/home/gusto-pastila-01@1.5x.webp">-->
<!--                <img src="--><?php //echo get_template_directory_uri(); ?><!--/git-src/build/img/home/gusto-pastila-01@1.5x.jpg" alt="Project preview" loading="lazy">-->
<!--              </picture>-->
<!--            </div>-->
<!--          </a>-->
<!--        </div>-->
