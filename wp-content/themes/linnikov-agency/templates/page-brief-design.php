      ...
      <form id="brief-form" class="tg-regular application-form" enctype="multipart/form-data">
        ...
        <div class="section-container section-container_decor application-form__container">
          <div class="form__body application-form__body" data-elem="body">
            ...
            <div class="animated-separator"></div>
            <div class="section-container__inner field-wrap_t field-wrap_b app-form-block">
              <div class="tg-regular app-form-block__cap">What will we be working with? Is this a first-time launch or a redesign? What’s the name of the product or service? Do you already have a website? If so, please share the link with us.
              </div>
              <div class="app-form-block__body">
            ...
            <div class="animated-separator"></div>
            <div class="section-container__inner field-wrap_t field-wrap_b app-form-block">
              <div class="tg-regular app-form-block__cap">What are the company's plans and objectives for the new website? We’re not looking for financial goals, but rather the company's purpose or vision behind this project.</div>
              <div class="app-form-block__body">
                <div class="form-field form-field_width-limit">
            ...
            <div class="animated-separator"></div>
            <div class="section-container__inner field-wrap_t field-wrap_b app-form-block">
              <div class="tg-regular app-form-block__cap">What is the nature and lifestyle of your target user? Please describe your target audiences in detail. How should the website appeal to them?
              </div>
              <div class="app-form-block__body">
                <div class="form-field form-field_width-limit">
            ...
            <div class="animated-separator"></div>
            <div class="section-container__inner field-wrap_t field-wrap_b app-form-block">
              <div class="tg-regular app-form-block__cap">How do you convince customers that your product is better than competing alternatives, and how should the website support that message?
              </div>
              <div class="app-form-block__body">
                <div class="form-field form-field_width-limit">
            ...
            <div class="animated-separator"></div>
            <div class="section-container__inner field-wrap_t field-wrap_b app-form-block">
              <div class="tg-regular app-form-block__cap">Who are your competitors, and what are their websites? What do you like or dislike about them?
              </div>
              <div class="app-form-block__body">
                <div class="form-field form-field_width-limit">
            ...
            <div class="animated-separator"></div>
            <div class="section-container__inner field-wrap_t field-wrap_b app-form-block">
              <div class="tg-regular app-form-block__cap">What design style should the website reflect? (e.g., modern, trustworthy, innovative)? Please share any examples of design styles you like.
              </div>
              <div class="app-form-block__body">
                <div class="form-field form-field_width-limit">
            ...
            <div class="animated-separator"></div>
            <div class="section-container__inner field-wrap_t field-wrap_b app-form-block">
              <div class="tg-regular app-form-block__cap">What functionality is critical for the website (e.g., e-commerce, booking system, blog)?
              </div>
              <div class="app-form-block__body">
                <div class="form-field form-field_width-limit">
            ...
            <div class="animated-separator"></div>
            <div class="section-container__inner field-wrap_t field-wrap_b app-form-block">
              <div class="tg-regular app-form-block__cap">How many pages or sections will the website have approximately, and do you have an existing sitemap?
              </div>
              <div class="app-form-block__body">
                <div class="form-field form-field_width-limit">
            ...
            <div class="animated-separator"></div>
            <div class="section-container__inner field-wrap_t field-wrap_b app-form-block">
              <div class="tg-regular app-form-block__cap">Do you need integration with any external tools or platforms (e.g., CRM, email marketing, payment gateways)?
              </div>
              <div class="app-form-block__body">
                <div class="form-field form-field_width-limit">
            ...
            <div class="animated-separator"></div>
            <div class="section-container__inner field-wrap_t field-wrap_b app-form-block">
              <div class="tg-regular app-form-block__cap">Will the website need to support multiple languages? If yes, please list all the languages required.
              </div>
              <div class="app-form-block__body">
                <div class="form-field form-field_width-limit">
            ...
            <div class="animated-separator"></div>
            <div class="section-container__inner field-wrap_t field-wrap_b app-form-block">
              <div class="tg-regular app-form-block__cap">Are there any limitations that must be considered, such as existing branding, content, CMS, or technical specifications?
              </div>
              <div class="app-form-block__body">
                <div class="form-field form-field_width-limit">
            ...
            <div class="animated-separator"></div>
            <div class="section-container__inner field-wrap_t field-wrap_b app-form-block">
              <div class="tg-regular app-form-block__cap">How do you envision the design style for your website (overall feel, fonts, colors, icons, patterns, photo style)? What character or personality should the website convey?
              </div>
              <div class="app-form-block__body">
