                ...
                <div class="testimonials__wrap">
                    <div class="testimonials__inner">
                        ...
                        <div class="keen-slider testimonials__header">
                            ...
                            <div class="keen-slider__slide">
                                <button type="button" class="testimonials-btn testimonials__client"
                                        data-name="crowdfunding-lawyers">
                            ...
                            <div class="keen-slider__slide">
                                <button type="button" class="testimonials-btn testimonials__client"
                                        data-name="devspiration">
                                    <div class="testimonials-btn__cap">Select by devspiration</div>
                                    <img src="<?php echo get_template_directory_uri(); ?>/git-src/build/img/clients/devspiration.svg" class="testimonials-btn__logo"
                                         alt="devspiration">
                                </button>
                            </div>
                            <div class="keen-slider__slide">
                                ...
                                <div class="testimonials-card__inner">
                                    ...
                                    <div class="testimonials-card__quote">
                                        <div class="tg-h3 testimonials-quote">
                                            <span class="testimonials-quote-sign testimonials-quote-sign_open">“</span>
                                            <span data-to-split>
												Their quality of work is very <span
                                                        class="white-space-nowrap"> high.<span
                                                            class="testimonials-quote-sign testimonials-quote-sign_close">”</span></span>
												</span>
                                        </div>
                                    </div>
                        ...
                        <ul class="awards-showcase-flex__inner">
                            ...
                            <li class="awards-showcase-flex__item">
                                <div class="award-card">
                                    ...
                                    <div class="award-card__place">Тор Packaging design company supply chain, logistics, and
                            ...
                            <li class="awards-showcase-flex__item">
                                <div class="award-card">
                                    ...
                                    <div class="award-card__place">Тор Packaging design<br>company supply chain,<br>logistics,
                                        and transport
                                    </div>
                                </div>
                            </li>
                            ...
                            <div class="reveal-wrap__inner">
                                <svg id="about-us-motto-star" class="animated-star reveal-wrap__item about-us-motto__star"
                                    ...
                                    <g mask="url(#about-us-motto-star-mask)">
                                        ...
                                        <path d="M148.914 213.881L0.867188 176.965L23.9395 102.749L166.603 164.275L154.682 0.0771484H232.359L218.9 166.583L360.41 106.21L383.867 181.58L233.513 216.957L334.646 341.548L271.198 388.077L189.675 246.182L108.538 383.847L44.7045 339.625L148.914 213.881Z"
                        ...
                        <div class="our-offer-msg__infinity-wrap reveal-wrap">
                            <div class="reveal-wrap__inner">
                                <div class="reveal-wrap__item"
                                     style="translate: none; rotate: none; scale: none; transform: translate(0px, 0px);">
                                    <svg>
                                        <use class="our-offer-msg__infinity" href="<?php echo get_template_directory_uri(); ?>/git-src/build/img/decor-symbols.svg#infinity"
