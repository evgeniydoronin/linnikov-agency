  ...
  <main>
    ...
    <section id="categories-grid" class="categories-grid">
      <div class="section-container section-container_decor categories-grid__container">
        ...
        if ($categories_grid && is_array($categories_grid)) :
          ?>
          <div class="categories-grid__inner">
            <?php foreach ($categories_grid as $index => $category) :
              // Извлекаем значения заголовков и описания
              $title1 = isset($category['title']) ? esc_html($category['title']) : '';
              $title2 = isset($category['title2']) ? esc_html($category['title2']) : '';
              $description = isset($category['description']) ? esc_html($category['description']) : '';

              // Статические значения data-id для каждой категории
              $data_ids = [1, 5, 3, 4, 6, 2, 7, 8];
              $data_id = isset($data_ids[$index]) ? $data_ids[$index] : 1;
              ?>
              <div class="category-card" data-active="true">
                <div class="category-card__inner">
                  ...
                  <div class="category-card__main" data-elem="main">
                    <div data-component="animated-icon" data-id="<?php echo esc_attr($data_id); ?>"
                    ...
                    <div class="category-card__title">
                      ...
                      <span class="white-space-nowrap">
                        <?php echo $title2; ?>
                        <span class="category-card__arrow ref-arrow-icon">
    ...
    <section id="cs-animation" class="cs-animation">
      <div class="section-container section-container_decor cs-animation__container" data-elem="cs-animation.container">
        <div class="cs-animation__sticky-container">
          <div class="section-container__inner cs-animation__inner" data-elem="cs-animation.inner">
            <div class="cs-animation__frame" data-elem="cs-animation.frame-01">
              <div class="cs-msg-01 cs-animation__msg-01" data-elem="cs-animation.msg-01">
                <div class="cs-msg-01__p1">Feeling</div>
                <div class="cs-msg-01__p2">&nbsp;> Thinking</div>
              </div>
              <div class="cs-msg-02 cs-animation__msg-02" data-elem="cs-animation.msg-02">
                On a daily basis, an individual is required to make over <span
                    class="no-wrap cs-msg-02__focus-group"><span
                      class="cs-msg-02__focus">35,000</span> decisions.</span>
              </div>
            </div>
            <div class="cs-animation__frame cs-animation__frame_center" data-elem="cs-animation.frame-02">
              <div class="cs-msg-03 cs-animation__msg-03" data-elem="cs-animation.msg-03">
                80%
              </div>
              <div class="cs-msg-04 cs-animation__msg-04" data-elem="cs-animation.msg-04">
                <div class="cs-msg-04__top">
                  <div class="reveal-wrap">
                    <div class="reveal-wrap__inner">
                      <div class="reveal-wrap__item">80% of these choices</div>
                    </div>
                  </div>
                  <div class="reveal-wrap">
                    <div class="reveal-wrap__inner">
                      <div class="reveal-wrap__item">are made based on</div>
                    </div>
                  </div>
                </div>
                <div class="cs-msg-04__scale-wrap">
                  <div class="reveal-wrap cs-msg-04__scale">
                    <div class="reveal-wrap__inner">
                      <div class="reveal-wrap__item">emoti
                        <div class="cs-msg-04__anchor">o</div>
                        nal impulses
                      </div>
                    </div>
                  </div>
                </div>
                <div class="cs-msg-04__bottom">
                  <div class="reveal-wrap">
                    <div class="reveal-wrap__inner">
                      <div class="reveal-wrap__item">rather than</div>
                    </div>
                  </div>
                  <div class="reveal-wrap">
                    <div class="reveal-wrap__inner">
                      <div class="reveal-wrap__item">rational thought</div>
                    </div>
                  </div>
                  <div class="reveal-wrap">
                    <div class="reveal-wrap__inner">
                      <div class="reveal-wrap__item">processes.</div>
                    </div>
                  </div>
                </div>
              </div>
            </div>
            <div class="cs-animation__frame cs-animation__frame_center" data-elem="cs-animation.frame-03">
              <div class="cs-msg-05" data-elem="cs-animation.msg-05">Trigger&nbsp;<div class="cs-msg-05__anchor">с</div>
                hange
              </div>
            </div>
          </div>
    ...
    <section class="cs-conclusion competencies__conclusion">
