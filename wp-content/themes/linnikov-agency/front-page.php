    ...
    <div class="header__main">
      <nav class="header-nav header-nav_left header__left">
        <div class="header-nav__inner">
          <a href="works.html" class="header-link text-btn" data-component="animated-link">
      ...
      <a href="." class="logo header__logo header__logo_home">
        <figure>
      ...
      <div class="header-submenu__inner">
        <div class="header-submenu__body" data-elem="disclosure.inner">
          <section class="header-submenu__section" data-submenu-elem="body->about">
            <a href="about-us.html" class="header-link text-btn header-link_sub-menu" data-component="animated-link">
              <div class="text-btn__cap">About us</div>
            </a>
            <a href="team.html" class="header-link text-btn header-link_sub-menu" data-component="animated-link">
              <div class="text-btn__cap">Team</div>
            </a>
            <a href="ideas.html" class="header-link text-btn header-link_sub-menu" data-component="animated-link">
              <div class="text-btn__cap">Ideas</div>
            </a>
            <a href="news.html" class="header-link text-btn header-link_sub-menu" data-component="animated-link">
              <div class="text-btn__cap">News</div>
            </a>
            <a href="careers.html" class="header-link text-btn header-link_sub-menu" data-component="animated-link">
              <div class="text-btn__cap">Careers</div>
            </a>
          </section>
        </div>
      </div>
      ...
      <div class="burger-menu__inner">
        <div class="burger-menu__header">
          <a href="." class="logo burger-menu__logo">
            <figure>
              <img src="<?php echo get_template_directory_uri(); ?>/git-src/build/img/logo-bright.svg" class="logo__img" alt="Light Logo">
              <figcaption aria-hidden="true">Main page</figcaption>
            </figure>
          </a>
        ...
        <nav class="burger-menu__nav">
          <div class="burger-menu__nav-section">
            <a href="works.html" class="header-link reveal-wrap">
              ...
              <div class="disclosure__inner" data-elem="disclosure.inner">
                <div class="burger-submenu">
                  <div class="burger-submenu__inner">
                    <a href="about-us.html" class="reveal-wrap header-link header-link_sub-menu">
                      <div class="reveal-wrap__inner">
                        <div class="line">About us</div>
                      </div>
                    </a>
                    <a href="team.html" class="reveal-wrap header-link header-link_sub-menu">
                      <div class="reveal-wrap__inner">
                        <div class="line">Team</div>
                      </div>
                    </a>
                    <a href="ideas.html" class="reveal-wrap header-link header-link_sub-menu">
                      <div class="reveal-wrap__inner">
                        <div class="line">Ideas</div>
                      </div>
                    </a>
                    <a href="news.html" class="reveal-wrap header-link header-link_sub-menu">
                      <div class="reveal-wrap__inner">
                        <div class="line">News</div>
                      </div>
                    </a>
                    <a href="careers.html" class="reveal-wrap header-link header-link_sub-menu">
                      <div class="reveal-wrap__inner">
        ...
        <form name="burger-theme-switch" class="theme-switch burger-menu__theme-switch" data-component="theme-switch">
          <label class="switch switch_theme">
            ...
            <svg class="switch__thumb theme-switch__thumb" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
              ...
              <circle cx="10" cy="10" r="10" fill="var(--inc-switch-thumb-color)" clip-path="url(#theme-switch-moon)"/>
            </svg>
          </label>
        </form>
      </div>
...
<section class="burger-btn-layer">
  <div class="section-container burger-btn-layer__container">
    <div class="burger-btn-layer__inner">
      <a href="." class="logo burger-btn-layer__logo header__logo_home">
        <figure>
          <img src="<?php echo get_template_directory_uri(); ?>/git-src/build/img/logo-bright.svg" class="logo__img" alt="Light Logo">
          <figcaption aria-hidden="true">Main page</figcaption>
        </figure>
...
<div>
            ...
            <div class="zoom-slider__wrapper" data-zs-elem="wrapper">
              <a href="." class="img-wrap img-wrap_cover case-poster case-poster_home-slider zoom-slider__slide"
                ...
                <div class="img-wrap__inner">
                  <picture>
                    <source type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/01.webp">
                    <img src="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/01.jpg" alt="Project preview" loading="lazy">
                  </picture>
                </div>
              ...
              <a href="." class="img-wrap img-wrap_cover case-poster case-poster_home-slider zoom-slider__slide"
                ...
                <div class="img-wrap__inner">
                  <picture>
                    <source type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/02.webp">
                    <img src="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/02.jpg" alt="Project preview" loading="lazy">
                  </picture>
                </div>
                <div class="reveal-wrap case-poster__title">
                  <div class="reveal-wrap__inner">
              ...
              <a href="." class="img-wrap img-wrap_cover case-poster case-poster_home-slider zoom-slider__slide"
                ...
                <div class="img-wrap__inner">
                  <picture>
                    <source type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/03.webp">
                    <img src="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/03.jpg" alt="Project preview" loading="lazy">
                  </picture>
                </div>
                <div class="reveal-wrap case-poster__title">
                  <div class="reveal-wrap__inner">
              ...
              <a href="." class="img-wrap img-wrap_cover case-poster case-poster_home-slider zoom-slider__slide"
                ...
                <div class="img-wrap__inner">
                  <picture>
                    <source type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/04.webp">
                    <img src="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/04.jpg" alt="Project preview" loading="lazy">
                  </picture>
                </div>
                <div class="reveal-wrap case-poster__title">
                  <div class="reveal-wrap__inner">
              ...
              <a href="." class="img-wrap img-wrap_cover case-poster case-poster_home-slider zoom-slider__slide"
                ...
                <div class="img-wrap__inner">
                  <picture>
                    <source type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/05.webp">
                    <img src="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/05.jpg" alt="Project preview" loading="lazy">
                  </picture>
                </div>
                <div class="reveal-wrap case-poster__title">
                  <div class="reveal-wrap__inner">
              ...
              <a href="." class="img-wrap img-wrap_cover case-poster case-poster_home-slider zoom-slider__slide"
                ...
                <div class="img-wrap__inner">
                  <picture>
                    <source type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/06.webp">
                    <img src="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/06.jpg" alt="Project preview" loading="lazy">
                  </picture>
                </div>
                <div class="reveal-wrap case-poster__title">
                  <div class="reveal-wrap__inner">
              ...
              <a href="." class="img-wrap img-wrap_cover case-poster case-poster_home-slider zoom-slider__slide"
                ...
                <div class="img-wrap__inner">
                  <picture>
                    <source type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/07.webp">
                    <img src="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/07.jpg" alt="Project preview" loading="lazy">
                  </picture>
                </div>
                <div class="reveal-wrap case-poster__title">
                  <div class="reveal-wrap__inner">
              ...
              <a href="." class="img-wrap img-wrap_cover case-poster case-poster_home-slider zoom-slider__slide"
                ...
                <div class="img-wrap__inner">
                  <picture>
                    <source type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/08.webp">
                    <img src="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/08.jpg" alt="Project preview" loading="lazy">
                  </picture>
                </div>
                <div class="reveal-wrap case-poster__title">
                  <div class="reveal-wrap__inner">
              ...
              <a href="." class="img-wrap img-wrap_cover case-poster case-poster_home-slider zoom-slider__slide"
                ...
                <div class="img-wrap__inner">
                  <picture>
                    <source type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/09.webp">
                    <img src="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/09.jpg" alt="Project preview" loading="lazy">
                  </picture>
                </div>
                <div class="reveal-wrap case-poster__title">
                  <div class="reveal-wrap__inner">
              ...
              <a href="." class="img-wrap img-wrap_cover case-poster case-poster_home-slider zoom-slider__slide"
                ...
                <div class="img-wrap__inner">
                  <picture>
                    <source type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/10.webp">
                    <img src="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/10.jpg" alt="Project preview" loading="lazy">
                  </picture>
                </div>
                <div class="reveal-wrap case-poster__title">
                  <div class="reveal-wrap__inner">
              ...
              <a href="." class="img-wrap img-wrap_cover case-poster case-poster_home-slider zoom-slider__slide"
                ...
                <div class="img-wrap__inner">
                  <picture>
                    <source type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/11.webp">
                    <img src="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/11.jpg" alt="Project preview" loading="lazy">
                  </picture>
                </div>
                <div class="reveal-wrap case-poster__title">
                  <div class="reveal-wrap__inner">
              ...
              <a href="." class="img-wrap img-wrap_cover case-poster case-poster_home-slider zoom-slider__slide"
                ...
                <div class="img-wrap__inner">
                  <picture>
                    <source type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/12.webp">
                    <img src="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/12.jpg" alt="Project preview" loading="lazy">
                  </picture>
                </div>
                <div class="reveal-wrap case-poster__title">
                  <div class="reveal-wrap__inner">
              ...
              <a href="." class="img-wrap img-wrap_cover case-poster case-poster_home-slider zoom-slider__slide"
                ...
                <div class="img-wrap__inner">
                  <picture>
                    <source type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/13.webp">
                    <img src="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/13.jpg" alt="Project preview" loading="lazy">
                  </picture>
                </div>
                <div class="reveal-wrap case-poster__title">
                  <div class="reveal-wrap__inner">
              ...
              <a href="." class="img-wrap img-wrap_cover case-poster case-poster_home-slider zoom-slider__slide"
                ...
                <div class="img-wrap__inner">
                  <picture>
                    <source type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/14.webp">
                    <img src="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/14.jpg" alt="Project preview" loading="lazy">
                  </picture>
                </div>
                <div class="reveal-wrap case-poster__title">
                  <div class="reveal-wrap__inner">
              ...
              <a href="." class="img-wrap img-wrap_cover case-poster case-poster_home-slider zoom-slider__slide"
                ...
                <div class="img-wrap__inner">
                  <picture>
                    <source type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/15.webp">
                    <img src="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/15.jpg" alt="Project preview" loading="lazy">
                  </picture>
                </div>
                <div class="reveal-wrap case-poster__title">
                  <div class="reveal-wrap__inner">
              ...
              <a href="." class="img-wrap img-wrap_cover case-poster case-poster_home-slider zoom-slider__slide"
                ...
                <div class="img-wrap__inner">
                  <picture>
                    <source type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/16.webp">
                    <img src="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/16.jpg" alt="Project preview" loading="lazy">
                  </picture>
                </div>
                <div class="reveal-wrap case-poster__title">
                  <div class="reveal-wrap__inner">
              ...
              <a href="." class="img-wrap img-wrap_cover case-poster case-poster_home-slider zoom-slider__slide"
                ...
                <div class="img-wrap__inner">
                  <picture>
                    <source type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/17.webp">
                    <img src="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/17.jpg" alt="Project preview" loading="lazy">
                  </picture>
                </div>
                <div class="reveal-wrap case-poster__title">
                  <div class="reveal-wrap__inner">
              ...
              <a href="." class="img-wrap img-wrap_cover case-poster case-poster_home-slider zoom-slider__slide"
                ...
                <div class="img-wrap__inner">
                  <picture>
                    <source type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/18.webp">
                    <img src="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/18.jpg" alt="Project preview" loading="lazy">
                  </picture>
                </div>
                <div class="reveal-wrap case-poster__title">
                  <div class="reveal-wrap__inner">
              ...
              <a href="." class="img-wrap img-wrap_cover case-poster case-poster_home-slider zoom-slider__slide"
                ...
                <div class="img-wrap__inner">
                  <picture>
                    <source type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/19.webp">
                    <img src="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/19.jpg" alt="Project preview" loading="lazy">
                  </picture>
                </div>
                <div class="reveal-wrap case-poster__title">
                  <div class="reveal-wrap__inner">
              ...
              <a href="." class="img-wrap img-wrap_cover case-poster case-poster_home-slider zoom-slider__slide"
                ...
                <div class="img-wrap__inner">
                  <picture>
                    <source type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/20.webp">
                    <img src="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/20.jpg" alt="Project preview" loading="lazy">
                  </picture>
                </div>
                <div class="reveal-wrap case-poster__title">
                  <div class="reveal-wrap__inner">
              ...
              <a href="." class="img-wrap img-wrap_cover case-poster case-poster_home-slider zoom-slider__slide"
                ...
                <div class="img-wrap__inner">
                  <picture>
                    <source type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/21.webp">
                    <img src="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/21.jpg" alt="Project preview" loading="lazy">
                  </picture>
                </div>
                <div class="reveal-wrap case-poster__title">
                  <div class="reveal-wrap__inner">
              ...
              <a href="." class="img-wrap img-wrap_cover case-poster case-poster_home-slider zoom-slider__slide"
                ...
                <div class="img-wrap__inner">
                  <picture>
                    <source type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/22.webp">
                    <img src="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/22.jpg" alt="Project preview" loading="lazy">
                  </picture>
                </div>
                <div class="reveal-wrap case-poster__title">
                  <div class="reveal-wrap__inner">
              ...
              <a href="." class="img-wrap img-wrap_cover case-poster case-poster_home-slider zoom-slider__slide"
                ...
                <div class="img-wrap__inner">
                  <picture>
                    <source type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/23.webp">
                    <img src="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/23.jpg" alt="Project preview" loading="lazy">
                  </picture>
                </div>
                <div class="reveal-wrap case-poster__title">
                  <div class="reveal-wrap__inner">
              ...
              <a href="." class="img-wrap img-wrap_cover case-poster case-poster_home-slider zoom-slider__slide"
                ...
                <div class="img-wrap__inner">
                  <picture>
                    <source type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/24.webp">
                    <img src="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/24.jpg" alt="Project preview" loading="lazy">
                  </picture>
                </div>
                <div class="reveal-wrap case-poster__title">
                  <div class="reveal-wrap__inner">
              ...
              <a href="." class="img-wrap img-wrap_cover case-poster case-poster_home-slider zoom-slider__slide"
                ...
                <div class="img-wrap__inner">
                  <picture>
                    <source type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/25.webp">
                    <img src="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/25.jpg" alt="Project preview" loading="lazy">
                  </picture>
                </div>
                <div class="reveal-wrap case-poster__title">
                  <div class="reveal-wrap__inner">
              ...
              <a href="." class="img-wrap img-wrap_cover case-poster case-poster_home-slider zoom-slider__slide"
                ...
                <div class="img-wrap__inner">
                  <picture>
                    <source type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/26.webp">
                    <img src="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/26.jpg" alt="Project preview" loading="lazy">
                  </picture>
                </div>
                <div class="reveal-wrap case-poster__title">
                  <div class="reveal-wrap__inner">
              ...
              <a href="." class="img-wrap img-wrap_cover case-poster case-poster_home-slider zoom-slider__slide"
                ...
                <div class="img-wrap__inner">
                  <picture>
                    <source type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/27.webp">
                    <img src="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/27.jpg" alt="Project preview" loading="lazy">
                  </picture>
                </div>
                <div class="reveal-wrap case-poster__title">
                  <div class="reveal-wrap__inner">
              ...
              <a href="." class="img-wrap img-wrap_cover case-poster case-poster_home-slider zoom-slider__slide"
                ...
                <div class="img-wrap__inner">
                  <picture>
                    <source type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/28.webp">
                    <img src="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/28.jpg" alt="Project preview" loading="lazy">
                  </picture>
                </div>
                <div class="reveal-wrap case-poster__title">
                  <div class="reveal-wrap__inner">
              ...
              <a href="." class="img-wrap img-wrap_cover case-poster case-poster_home-slider zoom-slider__slide"
                ...
                <div class="img-wrap__inner">
                  <picture>
                    <source type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/29.webp">
                    <img src="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/29.jpg" alt="Project preview" loading="lazy">
                  </picture>
                </div>
                <div class="reveal-wrap case-poster__title">
                  <div class="reveal-wrap__inner">
              ...
              <a href="." class="img-wrap img-wrap_cover case-poster case-poster_home-slider zoom-slider__slide"
                ...
                <div class="img-wrap__inner">
                  <picture>
                    <source type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/30.webp">
                    <img src="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/30.jpg" alt="Project preview" loading="lazy">
                  </picture>
                </div>
                <div class="reveal-wrap case-poster__title">
                  <div class="reveal-wrap__inner">
              ...
              <a href="." class="img-wrap img-wrap_cover case-poster case-poster_home-slider zoom-slider__slide"
                ...
                <div class="img-wrap__inner">
                  <picture>
                    <source type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/31.webp">
                    <img src="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/31.jpg" alt="Project preview" loading="lazy">
                  </picture>
                </div>
                <div class="reveal-wrap case-poster__title">
                  <div class="reveal-wrap__inner">
              ...
              <a href="." class="img-wrap img-wrap_cover case-poster case-poster_home-slider zoom-slider__slide"
                ...
                <div class="img-wrap__inner">
                  <picture>
                    <source type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/32.webp">
                    <img src="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/32.jpg" alt="Project preview" loading="lazy">
                  </picture>
                </div>
                <div class="reveal-wrap case-poster__title">
                  <div class="reveal-wrap__inner">
              ...
              <a href="." class="img-wrap img-wrap_cover case-poster case-poster_home-slider zoom-slider__slide"
                ...
                <div class="img-wrap__inner">
                  <picture>
                    <source type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/33.webp">
                    <img src="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/33.jpg" alt="Project preview" loading="lazy">
                  </picture>
                </div>
                <div class="reveal-wrap case-poster__title">
                  <div class="reveal-wrap__inner">
              ...
              <a href="." class="img-wrap img-wrap_cover case-poster case-poster_home-slider zoom-slider__slide"
                ...
                <div class="img-wrap__inner">
                  <picture>
                    <source type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/34.webp">
                    <img src="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/34.jpg" alt="Project preview" loading="lazy">
                  </picture>
                </div>
                <div class="reveal-wrap case-poster__title">
                  <div class="reveal-wrap__inner">
              ...
              <a href="." class="img-wrap img-wrap_cover case-poster case-poster_home-slider zoom-slider__slide"
                ...
                <div class="img-wrap__inner">
                  <picture>
                    <source type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/35.webp">
                    <img src="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/35.jpg" alt="Project preview" loading="lazy">
                  </picture>
                </div>
                <div class="reveal-wrap case-poster__title">
                  <div class="reveal-wrap__inner">
              ...
              <a href="." class="img-wrap img-wrap_cover case-poster case-poster_home-slider zoom-slider__slide"
                ...
                <div class="img-wrap__inner">
                  <picture>
                    <source type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/36.webp">
                    <img src="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/36.jpg" alt="Project preview" loading="lazy">
                  </picture>
                </div>
                <div class="reveal-wrap case-poster__title">
                  <div class="reveal-wrap__inner">
              ...
              <a href="." class="img-wrap img-wrap_cover case-poster case-poster_home-slider zoom-slider__slide"
                ...
                <div class="img-wrap__inner">
                  <picture>
                    <source type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/37.webp">
                    <img src="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/37.jpg" alt="Project preview" loading="lazy">
                  </picture>
                </div>
                <div class="reveal-wrap case-poster__title">
                  <div class="reveal-wrap__inner">
              ...
              <a href="." class="img-wrap img-wrap_cover case-poster case-poster_home-slider zoom-slider__slide"
                ...
                <div class="img-wrap__inner">
                  <picture>
                    <source type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/38.webp">
                    <img src="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/38.jpg" alt="Project preview" loading="lazy">
                  </picture>
                </div>
                <div class="reveal-wrap case-poster__title">
                  <div class="reveal-wrap__inner">
              ...
              <a href="." class="img-wrap img-wrap_cover case-poster case-poster_home-slider zoom-slider__slide"
                ...
                <div class="img-wrap__inner">
                  <picture>
                    <source type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/39.webp">
                    <img src="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/39.jpg" alt="Project preview" loading="lazy">
                  </picture>
                </div>
                <div class="reveal-wrap case-poster__title">
                  <div class="reveal-wrap__inner">
              ...
              <a href="." class="img-wrap img-wrap_cover case-poster case-poster_home-slider zoom-slider__slide"
                ...
                <div class="img-wrap__inner">
                  <picture>
                    <source type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/40.webp">
                    <img src="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/40.jpg" alt="Project preview" loading="lazy">
                  </picture>
                </div>
                <div class="reveal-wrap case-poster__title">
                  <div class="reveal-wrap__inner">
              ...
              <a href="." class="img-wrap img-wrap_cover case-poster case-poster_home-slider zoom-slider__slide"
                ...
                <div class="img-wrap__inner">
                  <picture>
                    <source type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/41.webp">
                    <img src="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/41.jpg" alt="Project preview" loading="lazy">
                  </picture>
                </div>
                <div class="reveal-wrap case-poster__title">
                  <div class="reveal-wrap__inner">
              ...
              <a href="." class="img-wrap img-wrap_cover case-poster case-poster_home-slider zoom-slider__slide"
                ...
                <div class="img-wrap__inner">
                  <picture>
                    <source type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/42.webp">
                    <img src="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/42.jpg" alt="Project preview" loading="lazy">
                  </picture>
                </div>
                <div class="reveal-wrap case-poster__title">
                  <div class="reveal-wrap__inner">
              ...
              <a href="." class="img-wrap img-wrap_cover case-poster case-poster_home-slider zoom-slider__slide"
                ...
                <div class="img-wrap__inner">
                  <picture>
                    <source type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/43.webp">
                    <img src="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/43.jpg" alt="Project preview" loading="lazy">
                  </picture>
                </div>
                <div class="reveal-wrap case-poster__title">
                  <div class="reveal-wrap__inner">
              ...
              <a href="." class="img-wrap img-wrap_cover case-poster case-poster_home-slider zoom-slider__slide"
                ...
                <div class="img-wrap__inner">
                  <picture>
                    <source type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/44.webp">
                    <img src="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/44.jpg" alt="Project preview" loading="lazy">
                  </picture>
                </div>
                <div class="reveal-wrap case-poster__title">
                  <div class="reveal-wrap__inner">
              ...
              <a href="." class="img-wrap img-wrap_cover case-poster case-poster_home-slider zoom-slider__slide"
                ...
                <div class="img-wrap__inner">
                  <picture>
                    <source type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/45.webp">
                    <img src="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/45.jpg" alt="Project preview" loading="lazy">
                  </picture>
                </div>
                <div class="reveal-wrap case-poster__title">
                  <div class="reveal-wrap__inner">
              ...
              <a href="." class="img-wrap img-wrap_cover case-poster case-poster_home-slider zoom-slider__slide"
                ...
                <div class="img-wrap__inner">
                  <picture>
                    <source type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/46.webp">
                    <img src="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/46.jpg" alt="Project preview" loading="lazy">
                  </picture>
                </div>
                <div class="reveal-wrap case-poster__title">
                  <div class="reveal-wrap__inner">
              ...
              <a href="." class="img-wrap img-wrap_cover case-poster case-poster_home-slider zoom-slider__slide"
                ...
                <div class="img-wrap__inner">
                  <picture>
                    <source type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/47.webp">
                    <img src="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/47.jpg" alt="Project preview" loading="lazy">
                  </picture>
                </div>
                <div class="reveal-wrap case-poster__title">
                  <div class="reveal-wrap__inner">
              ...
              <a href="." class="img-wrap img-wrap_cover case-poster case-poster_home-slider zoom-slider__slide"
                ...
                <div class="img-wrap__inner">
                  <picture>
                    <source type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/48.webp">
                    <img src="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/48.jpg" alt="Project preview" loading="lazy">
                  </picture>
                </div>
                <div class="reveal-wrap case-poster__title">
                  <div class="reveal-wrap__inner">
              ...
              <a href="." class="img-wrap img-wrap_cover case-poster case-poster_home-slider zoom-slider__slide"
                ...
                <div class="img-wrap__inner">
                  <picture>
                    <source type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/49.webp">
                    <img src="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/49.jpg" alt="Project preview" loading="lazy">
                  </picture>
                </div>
                <div class="reveal-wrap case-poster__title">
                  <div class="reveal-wrap__inner">
              ...
              <a href="." class="img-wrap img-wrap_cover case-poster case-poster_home-slider zoom-slider__slide"
                ...
                <div class="img-wrap__inner">
                  <picture>
                    <source type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/50.webp">
                    <img src="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/slider/50.jpg" alt="Project preview" loading="lazy">
                  </picture>
                </div>
                <div class="reveal-wrap case-poster__title">
                  <div class="reveal-wrap__inner">
      ...
      <div class="section-container section-container_decor about__container">
        <div class="section-container__inner" data-component="sliding-text">
          <h1 class="text-rgb-shake" data-elem="text">
            <div class="about-text-wrap" data-elem="main-text">Linnikov is a transformation branding agency specializing
              in business evolution
            </div>
            <div class="text-rgb-shake__set about__rgb-set" aria-hidden="true" data-elem="rgb-set">
              <div class="about-text-wrap">Linnikov is a transformation branding agency specializing in business
                evolution
              </div>
              <div class="about-text-wrap">Linnikov is a transformation branding agency specializing in business
                evolution
      ...
      <div class="section-container section-container_decor top-cases__container">
        ...
        <div class="top-cases__body" data-top-cases-elem="body">
          <a href="." data-cursor="none" class="img-wrap img-wrap_cover case-poster case-poster_top"
            ...
            <div class="img-wrap__inner">
              <picture>
                <source type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/iguana@2x.webp">
                <img src="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/iguana@2x.jpg" alt="Iguana" loading="lazy">
              </picture>
            </div>
          </a>
          <a href="." data-cursor="none" class="img-wrap img-wrap_cover case-poster case-poster_top"
            ...
            <div class="img-wrap__inner">
              <picture>
                <source type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/khush@2x.webp">
                <img src="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/khush@2x.jpg" alt="Khush" loading="lazy">
              </picture>
            </div>
          </a>
          <a href="." data-cursor="none" class="img-wrap img-wrap_cover case-poster case-poster_top"
            ...
            <div class="img-wrap__inner">
              <picture>
                <source type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/the-moon@2x.webp">
                <img src="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/the-moon@2x.jpg" alt="Project preview" loading="lazy">
              </picture>
            </div>
          </a>
          <a href="." data-cursor="none" class="img-wrap img-wrap_cover case-poster case-poster_top"
            ...
            <div class="img-wrap__inner">
              <picture>
                <source type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/rgb-pot@1.5x.webp">
                <img src="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/rgb-pot@1.5x.jpg" alt="Project preview" loading="lazy">
              </picture>
            </div>
          </a>
          <a href="." data-cursor="none" class="img-wrap img-wrap_cover case-poster case-poster_top"
            ...
            <div class="img-wrap__inner">
              <picture>
                <source type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/aromanty@1.5x.webp">
                <img src="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/aromanty@1.5x.jpg" alt="Aromanty" loading="lazy">
              </picture>
            </div>
          </a>
          <a href="." data-cursor="none" class="img-wrap img-wrap_cover case-poster case-poster_top"
            ...
            <div class="img-wrap__inner">
              <picture>
                <source type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/glass-letters@1.5x.webp">
                <img src="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/glass-letters@1.5x.jpg" alt="Project preview" loading="lazy">
              </picture>
            </div>
          </a>
          <a href="." data-cursor="none" class="img-wrap img-wrap_cover case-poster case-poster_top"
            ...
            <div class="img-wrap__inner">
              <picture>
                <source type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/spf30@1.5x.webp">
                <img src="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/spf30@1.5x.jpg" alt="Project preview" loading="lazy">
              </picture>
            </div>
          </a>
          <a href="." data-cursor="none" class="img-wrap img-wrap_cover case-poster case-poster_top"
            ...
            <div class="img-wrap__inner">
              <picture>
                <source type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/gusto-pastila@2x.webp">
                <img src="<?php echo get_template_directory_uri(); ?>/git-src/build/img/home/gusto-pastila@2x.jpg" alt="Project preview" loading="lazy">
              </picture>
            </div>
          </a>
        </div>
        <div class="top-cases__all-works">
          <a href="works.html" class="tg-control text-btn" data-component="animated-link">
    ...
    <div data-lenis-prevent class="linnikov-chat" id="linnikov-chat" data-drawer="ai-chat">
      <div class="linnikov-chat__panel" data-elem="drawer.panel">
        ...
        <div class="linnikov-chat__header">
          ...
          <img src="<?php echo get_template_directory_uri(); ?>/git-src/build/img/chat/Linnikov_AI.svg" alt="Linnikov AI" loading="lazy" class="linnikov-chat__header-logo">
          ...
          <div class="linnikov-chat__body-content">
            <div class="linnikov-chat__line">
              <div class="linnikov-chat__line-icon">
                <img src="<?php echo get_template_directory_uri(); ?>/git-src/build/img/chat/chat_icon.svg" alt="Icon" loading="lazy">
              </div>
    ...
    <section class="drawer drawer_right request-drawer" data-drawer="request">
      <div data-lenis-prevent class="drawer__panel request-drawer__panel" data-elem="drawer.panel" data-scrollable>
        <section class="section-container section-container_decor request-drawer__body">
          ...
          <form id="request-form" class="request-form request-drawer__form">
          ...
          <div class="request-drawer-banner request-drawer__banner">
            <div class="img-wrap img-wrap_top-left request-drawer-banner__inner">
              <div class="img-wrap__inner">
                <picture>
                  <source srcset="<?php echo get_template_directory_uri(); ?>/git-src/build/img/request/banner-diagonal.webp">
  ...
  <div class="cursor" data-component="cursor">
    <span data-elem="current" class="icon-cubic-plus-big"></span>
    <span data-elem="next"></span>
  </div>
  <div class="ref-to-clipboard">
    <div class="ref-to-clipboard__tips">
      <div class="ref-to-clipboard__tips-body"></div>
    </div>
  </div>
  <div id="cta-widget" class="cta-widget">
    <button type="button" class="cta-widget-btn" data-drawer-open="request">
      <svg class="cta-widget-arrow cta-widget__icon" viewBox="0 0 12 20" xmlns="http://www.w3.org/2000/svg">
        <g class="cta-widget-arrow__rgb cta-widget-arrow__rgb_red">
          <rect class="cta-widget-arrow__tip" width="4" height="4" fill="var(--color, currentColor)"/>
          <rect class="cta-widget-arrow__tip" y="16" width="4" height="4" fill="var(--color, currentColor)"/>
          <rect class="cta-widget-arrow__middle" x="4" y="4" width="4" height="4" fill="var(--color, currentColor)"/>
          <rect class="cta-widget-arrow__middle" x="4" y="12" width="4" height="4" fill="var(--color, currentColor)"/>
          <rect class="cta-widget-arrow__nose" x="8" y="8" width="4" height="4" fill="var(--color, currentColor)"/>
        </g>
        <g class="cta-widget-arrow__rgb cta-widget-arrow__rgb_green">
          <rect class="cta-widget-arrow__tip" width="4" height="4" fill="var(--color, currentColor)"/>
          <rect class="cta-widget-arrow__tip" y="16" width="4" height="4" fill="var(--color, currentColor)"/>
          <rect class="cta-widget-arrow__middle" x="4" y="4" width="4" height="4" fill="var(--color, currentColor)"/>
          <rect class="cta-widget-arrow__middle" x="4" y="12" width="4" height="4" fill="var(--color, currentColor)"/>
        ...
        <g class="cta-widget-arrow__rgb cta-widget-arrow__rgb_blue">
          <rect class="cta-widget-arrow__tip" width="4" height="4" fill="var(--color, currentColor)"/>
          <rect class="cta-widget-arrow__tip" y="16" width="4" height="4" fill="var(--color, currentColor)"/>
          <rect class="cta-widget-arrow__middle" x="4" y="4" width="4" height="4" fill="var(--color, currentColor)"/>
          <rect class="cta-widget-arrow__middle" x="4" y="12" width="4" height="4" fill="var(--color, currentColor)"/>
      ...
      <div class="text-rgb-shake cta-widget-btn__cap">
        <div class="text-rgb-shake__main">Request</div>
        <div class="text-rgb-shake__set" aria-hidden="true">
          <div>Request</div>
          <div>Request</div>
          <div>Request</div>
        </div>
    ...
    <button type="button" class="cta-widget-btn" data-drawer-open="ai-chat">
      <div class="text-rgb-shake cta-widget-btn__cap">
        <div class="text-rgb-shake__main">AI chat</div>
        <div class="text-rgb-shake__set" aria-hidden="true">
          <div>AI chat</div>
          <div>AI chat</div>
          <div>AI chat</div>
  ...
  <footer class="footer" itemscope itemtype="http://schema.org/WPFooter">
    <div class="section-container section-container_decor footer__container">
      <div class="footer__inner">
        <div class="footer__top">
          <span class="footer__copyright">All rights reserved. <span itemprop="copyrightHolder">Linnikov agency</span>. <span
                itemprop="copyrightYear">2024</span>&nbsp;©</span>
          ...
          <div id="footer-go-up" class="footer__go-up-area">
            <button type="button" class="footer-go-up">
              <div class="footer-go-up__icon">
                <span class="icon-cubic-nav-arrow-right"></span>
              </div>
              <div class="footer-go-up__caption">Back to top</div>
            </button>
          </div>
        </div>
          ...
          <div id="footer-cta-msg-section" class="footer__middle">
            <a href="" target="_blank" class="footer-cta-msg footer__cta-msg">
              <div class="line">
                ...
                <div class="reveal-wrap">
                  <div class="reveal-wrap__inner">
												<span id="footer-cta-msg-part" class="changing-words">
													<span class="text-rgb-shake">
														<span>CREATE</span>
														<span class="text-rgb-shake__set" aria-hidden="true">
															<span>CREATE</span>
															<span>CREATE</span>
															<span>CREATE</span>
														</span>
              ...
              <div class="line">
                ...
                <div class="reveal-wrap">
                  <div class="reveal-wrap__inner">
												<span class="ref-arrow-icon footer-cta-msg__arrow">
            ...
            <div class="section-decor footer-decor footer__decor">
              <div class="section-decor__inner footer-decor__inner">
                <div class="reveal-wrap section-decor__item footer-decor__item">
                  <div class="reveal-wrap__inner">
                    <div class="section-decor__item-body footer-decor__item-body"></div>
                  </div>
                </div>
                <div class="reveal-wrap section-decor__item footer-decor__item">
                  <div class="reveal-wrap__inner">
              ...
              <div class="section-decor__rgb-set">
                <div class="section-decor footer-decor">
                  <div class="section-decor__inner footer-decor__inner">
                    <div class="reveal-wrap section-decor__item footer-decor__item">
                      <div class="reveal-wrap__inner">
                        <div class="section-decor__item-body footer-decor__item-body"></div>
