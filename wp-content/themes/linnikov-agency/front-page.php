  ...
  <div>
      ...
      <div data-lenis-prevent class="linnikov-chat" id="linnikov-chat" data-drawer="ai-chat">
        <div class="linnikov-chat__panel" data-elem="drawer.panel">
          ...
          <div class="linnikov-chat__header">
            ...
            <img src="<?php echo get_template_directory_uri(); ?>/git-src/build/img/chat/Linnikov_AI.svg"
                 alt="Linnikov AI" loading="lazy" class="linnikov-chat__header-logo">
            ...
            <div class="reveal-wrap">
              <div class="reveal-wrap__inner">
                <a href="" class="text-btn lite-version-drawer__link reveal-wrap__item" data-component="animated-link">
                  <svg id="lite-version-drawer-link__lightning_1" class="animated-cubic-lightning text-btn__lightning"
                       viewBox="0 -1 16 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g class="animated-cubic-lightning__body"
                       clip-path="url(#lite-version-drawer-link__lightning_1-clip)"
                       transform="rotate(30 6.8 30) translate(-3)">
                      <rect class="animated-cubic-lightning__top" x="0" y="0" width="3.4" height="20"
                            fill="var(--color, currentColor)"/>
                      <rect class="animated-cubic-lightning__bottom" x="3.4" y="20" width="3.4" height="10"
                  ...
                  <svg id="lite-version-drawer-link__lightning_2" class="animated-cubic-lightning text-btn__lightning"
                       viewBox="0 -1 16 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g class="animated-cubic-lightning__body"
                       clip-path="url(#lite-version-drawer-link__lightning_2-clip)"
                       transform="rotate(30 6.8 30) translate(-3)">
                      <rect class="animated-cubic-lightning__top" x="0" y="0" width="3.4" height="20"
                            fill="var(--color, currentColor)"/>
                      <rect class="animated-cubic-lightning__bottom" x="3.4" y="20" width="3.4" height="10"
    ...
    <div id="cta-widget" class="cta-widget">
      <button type="button" class="cta-widget-btn" data-drawer-open="request">
        ...
        <div class="cta-widget-btn__cap">Request</div>
      </button>
      <button type="button" class="cta-widget-btn" data-drawer-open="ai-chat">
        <div class="cta-widget-btn__cap">AI chat</div>
        <svg class="cta-widget-arrow cta-widget__icon" viewBox="0 0 12 20" xmlns="http://www.w3.org/2000/svg">
          <g class="cta-widget-arrow__rgb cta-widget-arrow__rgb_red">
            <rect class="cta-widget-arrow__tip" width="4" height="4" fill="var(--color, currentColor)"/>
            <rect class="cta-widget-arrow__tip" y="16" width="4" height="4" fill="var(--color, currentColor)"/>
          ...
          <span class="footer__copyright">All rights reserved. <span itemprop="copyrightHolder">Linnikov agency</span>. <span
            ...
            <div class="footer-socials footer__socials">
              <a itemprop="sameAs" href="https://www.linkedin.com/company/linnikov" target="_blank" class="footer-link">
                ...
                Linkedin</a>
              <a itemprop="sameAs" href="https://www.instagram.com/linnikov.agency/" target="_blank"
                 class="footer-link">
                <div class="ref-arrow-icon ref-arrow-icon_horizontal">
                  <span class="icon-cubic-nav-arrow-right"></span>
                  <span class="icon-cubic-nav-arrow-right"></span>
          ...
          <div id="footer-sticky-container" class="footer__group">
            ...
            <div id="footer-logo-section" class="footer__bottom">
              <a href="." class="logo footer__logo">
                <figure>
                  <img src="<?php echo get_template_directory_uri(); ?>/git-src/build/img/logo-dark.svg"
                       class="logo__img"
                       alt="Light Logo">
                  <figcaption aria-hidden="true">Main page</figcaption>
                </figure>
